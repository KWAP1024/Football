...
void main() {
  runApp(const Historyu());
}

class Historyu extends StatefulWidget {
  const Historyu({Key? key}) : super(key: key);

  @override
  HistoryuState createState() => HistoryuState();
}

class HistoryuState extends State<Historyu> {
  ...
  Future fetchData() async {
    ...
    const API_URL =
        'https://livescore-api.com/api-client/scores/history.json?competition_id=1&key=85C1LvsbG45sNOKv&secret=upUelWkmrvK3T9H2fj40PwcvBhYp6IUA';
