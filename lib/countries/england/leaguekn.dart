...
void main() {
  runApp(const Leaguekn());
}

class Leaguekn extends StatefulWidget {
  const Leaguekn({Key? key}) : super(key: key);

  @override
  LeagueknState createState() => LeagueknState();
}

class LeagueknState extends State<Leaguekn> {
  Map mapResponse = {};
  Map mapOfFacts = {};
  List listOfFacts = [];
  ...
  Future fetchData() async {
    ...
    const API_URL =
        'https://livescore-api.com/api-client/leagues/table.json?competition_id=2&key=85C1LvsbG45sNOKv&secret=upUelWkmrvK3T9H2fj40PwcvBhYp6IUA';
              ...
              child: Center(
                child: Column(
                  children: [
                    ...
                    Text(
                        'League Table is currently not available',
