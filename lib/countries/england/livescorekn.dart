...
void main() {
  runApp(const Livescorekn());
}

class Livescorekn extends StatefulWidget {
  const Livescorekn({Key? key}) : super(key: key);

  @override
  LivescoreknState createState() => LivescoreknState();
}

class LivescoreknState extends State<Livescorekn> {
  Map mapResponse = {};
  Map mapOfFacts = {};
  List listOfFacts = [];
  ...
  Future fetchData() async {
    ...
    const API_URL =
        'https://livescore-api.com/api-client/scores/live.json?competition_id=2&key=85C1LvsbG45sNOKv&secret=upUelWkmrvK3T9H2fj40PwcvBhYp6IUA';
