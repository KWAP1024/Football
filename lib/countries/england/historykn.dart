...
void main() {
  runApp(const Historykn());
}

class Historykn extends StatefulWidget {
  const Historykn({Key? key}) : super(key: key);

  @override
  HistoryknState createState() => HistoryknState();
}

class HistoryknState extends State<Historykn> {
  ...
  Future fetchData() async {
    ...
    const API_URL =
        'https://livescore-api.com/api-client/scores/history.json?competition_id=2&key=85C1LvsbG45sNOKv&secret=upUelWkmrvK3T9H2fj40PwcvBhYp6IUA';
