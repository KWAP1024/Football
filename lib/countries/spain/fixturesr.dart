...
import 'package:tanzanian_premier_league/countries/spain/historyr.dart';
import 'package:tanzanian_premier_league/countries/spain/leaguer.dart';
import 'package:tanzanian_premier_league/countries/spain/livescorer.dart';
...
void main() {
  runApp(const Fixturesr());
}

class Fixturesr extends StatefulWidget {
  const Fixturesr({Key? key}) : super(key: key);

  @override
  FixturesrState createState() => FixturesrState();
}

class FixturesrState extends State<Fixturesr> {
  ...
  Future fetchData() async {
    ...
    const API_URL =
        'https://livescore-api.com/api-client/fixtures/matches.json?competition_id=3&key=85C1LvsbG45sNOKv&secret=upUelWkmrvK3T9H2fj40PwcvBhYp6IUA';
