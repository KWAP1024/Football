...
void main() {
  runApp(const Historyr());
}

class Historyr extends StatefulWidget {
  const Historyr({Key? key}) : super(key: key);

  @override
  HistoryrState createState() => HistoryrState();
}

class HistoryrState extends State<Historyr> {
  ...
  Future fetchData() async {
    ...
    const API_URL =
        'https://livescore-api.com/api-client/scores/history.json?competition_id=3&key=85C1LvsbG45sNOKv&secret=upUelWkmrvK3T9H2fj40PwcvBhYp6IUA';
