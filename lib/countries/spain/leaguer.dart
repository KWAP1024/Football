...
void main() {
  runApp(const Leaguer());
}

class Leaguer extends StatefulWidget {
  const Leaguer({Key? key}) : super(key: key);

  @override
  LeaguerState createState() => LeaguerState();
}

class LeaguerState extends State<Leaguer> {
  Map mapResponse = {};
  Map mapOfFacts = {};
  List listOfFacts = [];
  ...
  Future fetchData() async {
    ...
    const API_URL =
        'https://livescore-api.com/api-client/leagues/table.json?competition_id=3&key=85C1LvsbG45sNOKv&secret=upUelWkmrvK3T9H2fj40PwcvBhYp6IUA';
              ...
              child: Center(
                child: Column(
                  children: [
                    ...
                    Text(
                        'League Table cannot be diplayed at the moment',
