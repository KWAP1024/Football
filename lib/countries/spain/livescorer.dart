...
void main() {
  runApp(const Livescorer());
}

class Livescorer extends StatefulWidget {
  const Livescorer({Key? key}) : super(key: key);

  @override
  LivescorerState createState() => LivescorerState();
}

class LivescorerState extends State<Livescorer> {
  Map mapResponse = {};
  Map mapOfFacts = {};
  List listOfFacts = [];
  ...
  Future fetchData() async {
    ...
    const API_URL =
        'https://livescore-api.com/api-client/scores/live.json?competition_id=3&key=85C1LvsbG45sNOKv&secret=upUelWkmrvK3T9H2fj40PwcvBhYp6IUA';
