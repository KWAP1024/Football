...
import 'package:tanzanian_premier_league/countries/tanzania/historytz.dart';
...
void main() {
  runApp(const Livescoretz());
}

class Livescoretz extends StatefulWidget {
  const Livescoretz({Key? key}) : super(key: key);

  @override
  LivescoretzState createState() => LivescoretzState();
}

class LivescoretzState extends State<Livescoretz> {
  Map mapResponse = {};
  Map mapOfFacts = {};
  List listOfFacts = [];
  ...
  Future fetchData() async {
    ...
    const API_URL =
        'https://livescore-api.com/api-client/scores/live.json?competition_id=80&key=85C1LvsbG45sNOKv&secret=upUelWkmrvK3T9H2fj40PwcvBhYp6IUA';
