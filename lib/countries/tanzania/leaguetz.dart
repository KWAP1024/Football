...
void main() {
  runApp(const Leaguetz());
}

class Leaguetz extends StatefulWidget {
  const Leaguetz({Key? key}) : super(key: key);

  @override
  LeaguetzState createState() => LeaguetzState();
}

class LeaguetzState extends State<Leaguetz> {
  Map mapResponse = {};
  Map mapOfFacts = {};
  List listOfFacts = [];
  ...
  Future fetchData() async {
    ...
    const API_URL =
        'https://livescore-api.com/api-client/leagues/table.json?competition_id=80&key=85C1LvsbG45sNOKv&secret=upUelWkmrvK3T9H2fj40PwcvBhYp6IUA';
