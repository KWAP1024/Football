...
void main() {
  runApp(const Fixturestz());
}

class Fixturestz extends StatefulWidget {
  const Fixturestz({Key? key}) : super(key: key);

  @override
  FixturestzState createState() => FixturestzState();
}

class FixturestzState extends State<Fixturestz> {
  ...
  Future fetchData() async {
    ...
    const API_URL =
        'https://livescore-api.com/api-client/fixtures/matches.json?competition_id=80&key=85C1LvsbG45sNOKv&secret=upUelWkmrvK3T9H2fj40PwcvBhYp6IUA';
